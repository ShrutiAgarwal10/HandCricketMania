...

{
    ...
    
    {
        ...
        String name; // to accept the name of player.
        int aa; // converting the random real number generated by 'rr' into  whole number.
        int ii; // used in  loops;
        ...
        while(infinity>0)
        {
            ...
            name=br.readLine();
                ...
                System.out.println(".");
                System.out.println("WELCOME TO THE HANDCRICKET-MANIA GAME");
                System.out.println(".");
            ...
            {
                System.out.print('\f');
                System.out.println("Adieu!. Come soon to play again.");
                break;
            }
